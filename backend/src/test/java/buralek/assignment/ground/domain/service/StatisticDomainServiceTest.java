...
class StatisticDomainServiceTest {
    ...
    private final StatisticDomainService statisticDomainService = new StatisticDomainService();
    ...
    void calculate1() {
        SampleStatistics result = statisticDomainService.calculate(List.of(), buildThreshold());
    ...
    void calculate2() {
        ...
        SampleStatistics result = statisticDomainService.calculate(samples, buildThreshold());
